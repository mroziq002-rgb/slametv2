        ...
        <div class="flex flex-col items-center justify-center min-h-screen gap-8 pb-24">
            <div class="text-center animate-fadeInDown" style="animation: fadeInDown 0.8s ease-out;">
                ...
                <div class="flex gap-4 justify-center flex-wrap">
                    <div class="feature-box" style="animation: fadeInUp 0.8s ease-out 0.1s backwards;">
                        <div class="text-4xl mb-2">🌹</div>
                        <h3>Mitra</h3>
                        <p>Lihat semua mitra</p>
                    </div>
                    <div class="feature-box" style="animation: fadeInUp 0.8s ease-out 0.2s backwards;">
                        <div class="text-4xl mb-2">🌺</div>
                        <h3>Produk</h3>
                        <p>Belanja sekarang</p>
                    </div>
                    <div class="feature-box" style="animation: fadeInUp 0.8s ease-out 0.3s backwards;">
                        <div class="text-4xl mb-2">🌼</div>
                        <h3>Akun</h3>
                        <p>Profil Anda</p>
                    </div>
