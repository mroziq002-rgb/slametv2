function renderProfile(container) {
    ...
    const profileHTML = `
        <div class="flex flex-col items-center p-6 pb-24">
            ...
            <h1 class="text-2xl font-bold text-gray-800 mb-2" style="animation: fadeInUp 0.8s ease-out 0.1s backwards;">� ghedawghedhiw 🍔</h1>
            <p class="text-gray-600 mb-6" style="animation: fadeInUp 0.8s ease-out 0.2s backwards;">ghedawghedhiw@kantin.com</p>
            ...
            <div class="w-full max-w-sm space-y-4" style="animation: fadeInUp 0.8s ease-out 0.3s backwards;">
                <div class="profile-info-box" style="border-left-color: #ec4899;">
                    ...
                    <p class="text-lg font-semibold text-gray-800">ghedawghedhiw</p>
                </div>
                <div class="profile-info-box" style="border-left-color: #f472b6;">
                    <p class="text-xs text-gray-500 mb-1">💌 Email</p>
                    <p class="text-lg font-semibold text-gray-800">ghedawghedhiw@kantin.com</p>
                </div>
...
function fetchProfileData() {
    return {
        photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ghedawghedhiw',
        name: 'ghedawghedhiw'
    };
}
